...
LastEditTime: 2021-11-22 20:40:55
'''
import os
import re
import numpy as np
...
for alpha in [0.5,1,2,3]:
    ...
    l1=plt.plot(x,y[0], marker='^', label='Gaussain',markersize=14,lw=4, color='#845EC2')
    l2=plt.plot(x,y[1], marker='^',label='+JSD',markersize=14,lw=4,color='#4B4453')
    l3=plt.plot(x,y[2],marker='^', label='+AutoAugment+JSD',markersize=12,lw=4,color='#B0A8B9')
    l4=plt.plot(x,y[3],marker='^', label='+AugMix+JSD',markersize=14,lw=4,color='#C34A36')
    l41=plt.plot(x,y[4],marker='^', label='+AugMix+HCR',markersize=14,lw=4,color='#4AA233')
    l5=plt.plot(x,y[5], marker='^',label='+FourierMix+JSD',markersize=14,lw=4,color='#FF8066')
    l6=plt.plot(x,y[6],marker='^', label='+FourierMix+HCR',markersize=14,lw=4,color='#4E8397')
    ...
    plt.savefig('./100analysis_'+str(alpha)+'.png',dpi=300,bbox_inches='tight')
