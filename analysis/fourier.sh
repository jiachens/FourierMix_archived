###
 # @Description: 
 # @Autor: Jiachen Sun
 # @Date: 2021-06-15 21:20:36
 # @LastEditors: Jiachen Sun
 # @LastEditTime: 2021-06-15 22:46:17
### 
...
do
    python ./code/fourier_analysis_cifar10.py cifar10-c --path ./data --corruption ${cor} --severity ${severity} --gpu 1
done
done
...
do
    python ./code/fourier_analysis_cifar10.py cifar10-c-bar --path ./data --corruption ${cor} --severity ${severity} --gpu 1
done
done