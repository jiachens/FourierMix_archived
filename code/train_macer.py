...
LastEditTime: 2021-07-07 23:02:54
'''
import argparse
import time
import os
...
if args.deferred:
    ...
    mode = f"macer"
args.outdir = args.outdir + f"/logs/{args.dataset}/{mode}/num_{args.num_noise_vec}/lbd_{args.lbd}/gamma_{args.margin}/beta_{args.beta}/noise_{args.noise_sd}"
