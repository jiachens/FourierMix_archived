...
LastEditTime: 2021-10-12 20:16:52
'''
import torch
...
def augment_single(x_orig,device=None):
    ...
    x_orig_f_abs *= 1. + flag * torch.rand(*x_orig_f_abs.shape).to(device) * c * 3
    ...
    t = [None,None,None,None,(1/24.,1/24.),(1/12.,1/12.),(1/8.,1/8.),(1/6.,1/6.)][severity_4-1] / 2.
