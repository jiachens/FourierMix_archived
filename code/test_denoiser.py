...
Description: 
Autor: Jiachen Sun
Date: 2021-07-26 19:53:10
LastEditors: Jiachen Sun
LastEditTime: 2021-07-26 19:53:47
'''
...
def main(args):
    ...
    if args.dataset == "cifar10-c":
        # print(args.path)
        test_dataset = get_dataset(args.dataset, None, args.path, args.corruption, args.severity)
    ...
    if args.clf != '':
        if args.clf in IMAGENET_CLASSIFIERS:
            ...
            try:
                ...
                base_classifier = get_architecture(args.clf, args.dataset, args.no_normalize)
        ...
        for i, (inputs, targets) in enumerate(loader):
            ...
            if i == 0:
                ...
                torchvision.utils.save_image(
                    test_img, "./test/denoiser_output_dir/denoise_test_"+str(noise_sd)+".png", nrow = 16
            )
            # print(classifier)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--outdir', type=str, default='./test/tmp_out/', help='folder to save model and training log)')
    parser.add_argument('--path', type=str, help='folder to pretrained classificaiton model)')
